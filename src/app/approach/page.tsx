  ...
  return (
    <main className="flex min-h-screen flex-col bg-cream text-charcoal">
      ...
      <section className="site-gutter w-full pb-[clamp(4rem,6vw,6rem)]">
        <div className="site-container grid lg:grid-cols-[0.72fr_1fr] gap-10 lg:gap-14 items-center">
          ...
          <div className="relative h-[clamp(24rem,38vw,32rem)] bg-charcoal overflow-hidden shadow-[0_24px_70px_-30px_rgba(0,0,0,0.22)] order-1 lg:order-2">
            <Image
